...
class AdapterDosen(
    ...
    private val customListenItem: ArrayList<DataKuliah>
) : ArrayAdapter<DataKuliah>(getContext, 0, customListenItem){
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (listLayout == null) {
            ...
            holder = ViewHolder()
            with(holder){
                tvNmDosen = listLayout.findViewById(R.id.tvNamaPengajar)
                tvNIDN = listLayout.findViewById(R.id.tvNIMDSN)
        ...
        holder.btnEdit!!.setOnClickListener {
            val i = Intent(context, PengentriDataPengajar::class.java)
